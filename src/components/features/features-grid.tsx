...
const PILOTS = [
  { initials: "JR", color: "#007AFF", name: "J. Reynolds" },
  { initials: "MC", color: "#30D158", name: "M. Chen" },
  { initials: "AP", color: "#38BFFF", name: "A. Patel" },
];

const WB_ROWS = [
  { label: "Pilot + Front", value: "340 lbs", ok: true },
  { label: "Rear Seats", value: "180 lbs", ok: true },
  { label: "Fuel (30 gal)", value: "180 lbs", ok: true },
  { label: "Baggage", value: "40 lbs", ok: true },
];
  ...
  return (
    <SectionWrapper id="aircraft">
      ...
      <div className="relative z-10 grid grid-cols-6 gap-3">
        ...
        <Card className="col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
          ...
          <CardContent className="pt-6">
            <div className="relative mx-auto flex aspect-square size-32 rounded-full border border-white/10 before:absolute before:-inset-2 before:rounded-full before:border before:border-white/5">
              <svg
                className="m-auto h-fit w-24 text-white/20"
                viewBox="0 0 212 143"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
                <path
                  ...
                  fill="currentColor"
                />
                <g clipPath="url(#clip0_feat_0)">
                  <path
                    d="M44.0209 55.3542C43.1945 54.7639 42.6916 54.0272 42.5121 53.1442C42.3327 52.2611 42.5995 51.345 43.3125 50.3958C50.632 40.3611 59.812 32.5694 70.8525 27.0208C81.8931 21.4722 93.668 18.6979 106.177 18.6979C118.691 18.6979 130.497 21.3849 141.594 26.7587C152.691 32.1326 161.958 39.8936 169.396 50.0417C170.222 51.1042 170.489 52.0486 170.196 52.875C169.904 53.7014 169.401 54.4097 168.688 55C167.979 55.5903 167.153 55.8571 166.208 55.8004C165.264 55.7437 164.438 55.2408 163.729 54.2917C157.236 45.0833 148.885 38.0307 138.675 33.1337C128.466 28.2368 117.633 25.786 106.177 25.7812C94.7257 25.7812 83.9827 28.2321 73.948 33.1337C63.9132 38.0354 55.5903 45.0881 48.9792 54.2917C48.2709 55.3542 47.4445 55.9444 46.5 56.0625C45.5556 56.1806 44.7292 55.9444 44.0209 55.3542Z"
                    fill="url(#paint0_linear_feat_0)"
                  />
                </g>
                <path
                ...
                />
                <defs>
                  <linearGradient id="paint0_linear_feat_0" x1="106.385" y1="1.34375" x2="106" y2="72" gradientUnits="userSpaceOnUse">
                    <stop stopColor="white" stopOpacity="0" />
                    <stop className="text-sky-500" offset="1" stopColor="currentColor" />
                  </linearGradient>
                  <clipPath id="clip0_feat_0">
            ...
            <div className="relative z-10 mt-6 space-y-2 text-center">
              <h2 className="text-lg font-medium">AI-Powered Briefings</h2>
              <p className="text-white/60">
                Gemini-powered co-pilot adapts to your aircraft, airport, and
        ...
        {/* Card 3 — Live Aviation Data */}
        <Card className="col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
          <GlowingEffect spread={40} glow={false} disabled={false} proximity={64} inactiveZone={0.01} borderWidth={2} />
          <CardContent className="pt-6">
            <div className="pt-6 lg:px-6">
              <svg
                className="text-white/20 w-full"
                viewBox="0 0 386 123"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
                <rect width="386" height="123" rx="10" />
                <g clipPath="url(#clip0_feat_106)">
                  <circle className="text-white/20" cx="29" cy="29" r="15" fill="currentColor" />
                  <path d="M29 23V35M35 29L29 35L23 29" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="
106" x1="3" y1="60" x2="3" y2="123" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#007AFF" stopOpacity="0.35" />
                    <stop offset="1" stopColor="transparent" stopOpacity="0.01" />
                  </linearGradient>
                  <clipPath id="clip0_feat_106">
            ...
            <div className="relative z-10 mt-8 space-y-2 text-center">
              <h2 className="text-lg font-medium">Live Aviation Data</h2>
              <p className="text-white/60">
                METAR, TAF, and NOTAMs pulled directly from aviation sources.
              </p>
            </div>
          </CardContent>
        </Card>

        {/* Card 4 — Weight & Balance */}
          ...
          <CardContent className="grid pt-6 sm:grid-cols-2">
            <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
              <div className="relative flex aspect-square size-12 rounded-full border border-white/10 before:absolute before:-inset-2 before:rounded-full before:border before:border-white/5">
                <Scale className="m-auto size-5" strokeWidth={1} />
              </div>
              <div className="space-y-2">
                ...
                <p className="text-white/60">
                  Calculate CG position instantly. Visual envelope keeps you
                  within limits before every flight.
                </p>
              </div>
            </div>
            <div className="rounded-tl-xl relative -mb-6 -mr-6 mt-6 h-fit border-l border-t border-white/[0.08] p-6 sm:ml-6">
              <div className="absolute left-3 top-2 flex gap-1">
                <span className="block size-2 rounded-full border border-white/10 bg-white/10" />
                <span className="block size-2 rounded-full border border-white/10 bg-white/10" />
                <span className="block size-2 rounded-full border border-white/10 bg-white/10" />
              </div>
              <p className="text-[10px] text-white/30 uppercase tracking-widest mb-4 mt-1">
                W&amp;B — C172S
              </p>
              <div className="space-y-2">
                {WB_ROWS.map((row, i) => (
                  <div key={i} className="flex items-center justify-between text-[11px]">
                    ...
                    <span className="text-white/70 font-mono">{row.value}</span>
                  </div>
                ))}
                <div className="border-t border-white/[0.08] pt-2 mt-2 space-y-1.5">
                  <div className="flex items-center justify-between text-[11px]">
                    <span className="text-white/40">Total Weight</span>
                    <span className="text-white font-mono font-medium">2,445 lbs</span>
                  </div>
                  <div className="flex items-center justify-between text-[11px]">
                    <span className="text-white/40">CG Position</span>
                    <span className="text-white font-mono font-medium">41.2 in</span>
                  </div>
                  <div className="flex items-center justify-between text-[11px] pt-1">
                    <span className="text-white/40">Status</span>
                    <span className="text-[#30D158] font-medium text-[10px] uppercase tracking-wide">✓ Within Limits</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* Aircraft Fleet — full width */}
        <Card className="col-span-full">
          <GlowingEffect spread={40} glow={false} disabled={false} proximity={64} inactiveZone={0.01} borderWidth={2} />
          <CardContent className="pt-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-base font-semibold">Supported Fleet</h3>
              <span className="text-[10px] text-white/40 border border-white/[0.08] rounded-full px-2 py-1">
                More coming soon
              </span>
            </div>
            <div className="flex gap-4 overflow-x-auto pb-2 -mx-2 px-2 snap-x">
              {AIRCRAFT.map((aircraft, i) => (
                <div
                  key={i}
                  className="flex-shrink-0 w-[140px] border border-white/[0.06] bg-white/[0.03] rounded-xl p-4 text-center snap-start hover:-translate-y-1 transition-transform"
                >
                  <Plane className="w-8 h-8 text-sky-500/60 mx-auto mb-2 -rotate-45" />
                  <p className="text-xs font-medium text-white">{aircraft.name}</p>
                  <p className="text-[10px] text-white/40">{aircraft.variant}</p>
                </div>
              ))}
            </div>
          </CardContent>
